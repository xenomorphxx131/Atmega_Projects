...
sensor_type = input("Enter Sensor Type [VL53L4CD/VL6180]: ")
...
if input("Program Device?") in ["Y", "y"]:
    ...
    sensor.write(f'SET:DETECTION_THRESHOLD_MM {2 if sensor_type=="VL6180" else 3}') # Trying to keep to 2mm. increase only if necessary for false trips.
