...
loadbox=lab_instruments.htx9000(master.get_visa_serial_interface("COM" + HTX9000_comport_number, timeout=1))
...
force_current_hi=[]
sense_current_hi=[]
for target_current in lab_utils.logRangeInc(start=25e-3,stop=2.5,stepsPerDecade=25):
    master.write("i_force", target_current)
    time.sleep(1)
    meter = master.read("i_sense")
    setting = master.read("i_force_readback")
