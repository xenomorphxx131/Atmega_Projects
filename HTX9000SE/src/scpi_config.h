...
***************************************************************************/
	#define COMMAND_ARRAY_SIZE	46 // Last command index is 41
/**************************************************************************
...
*  VERSIONS                                                               *
***************************************************************************/
	#define FIRMWARE_VERSION	"FIRMWARE REV 2.0" // Major update to the keypad code. Requires the keypad scanner pin to the pin that can capture the clock value.
